    ...
    opts = {
      mappings = {
        n = {
          ...
          ["<leader>uk1"] = { "<cmd>colorscheme kanagawa-wave<cr>", desc = "Kanagawa Wave" },
          ["<leader>uk2"] = { "<cmd>colorscheme kanagawa-dragon<cr>", desc = "Kanagawa Dragon" },
          ["<leader>uk3"] = { "<cmd>colorscheme kanagawa-lotus<cr>", desc = "Kanagawa Lotus" },
        },
        v = {
          H = { "^", desc = "Jump to line start" },
          L = { "$", desc = "Jump to line end" },
